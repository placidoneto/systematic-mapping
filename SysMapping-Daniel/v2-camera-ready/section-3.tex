...
%Figure \ref{fig:classificationscheme} shows the classification scheme that we propose to characterize data integration in multi-cloud environments considering SLAs. 
