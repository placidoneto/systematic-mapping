...
\begin{figure}[h!]
\centering 
%\includegraphics[scale=0.65]{figs/bubble-charts/Contribution-SLA-DIdescription.pdf}
...
\begin{figure}[h]
\centering
%\includegraphics[scale=0.60]{figs/bubble-charts/DI-Environment-Contribution-Research.pdf}
