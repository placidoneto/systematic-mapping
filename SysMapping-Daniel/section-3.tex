...
\paragraph{\textit{\textbf{RQ3:} In which way and in which context data integration has been linked to Quality of Service (QoS) measures in the literature?}} The objective of this question is to understand which QoS measures have been used for evaluating data integration and to determine the conditions in which  specific measures are particularly used.
...
appearances - 15.78\%)  used for facilitating data integration, mostly done in the {\em cloud}.  The most popular deployment environment of recent papers is the {\em cloud}. Given the maturity of the research addressing data integration it is that most papers present solutions (31 appearances - 27.19\%).
