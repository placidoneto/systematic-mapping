...
data integration in a multi-cloud environments} and  (ii) discover open issues and limitations of existing work.    
...
Facets and dimensions define the  scheme we used for  classifying the papers in the corpus according to dimensions. 
Each paper can be classified into one or several dimensions of each facet. This is discussed in the following section.
...
papers - 15.78\%)  used for facilitating data integration, mostly done in the {\em cloud}.  The most popular deployment environment of recent papers is the {\em cloud}. Given the importance and crucial need of data integration  most papers present solutions (31 papers - 27.19\%).
