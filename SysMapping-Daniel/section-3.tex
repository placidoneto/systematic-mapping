...
\begin{enumerate}
\item \textit{\textbf{RQ1:} Which are the SLA measures that have been applied most in
the cloud?} This question will help us to identify how SLA values have been
applied in the claud, and how they are been used.


\item \textit{\textbf{RQ2:}  How has the publication of papers on data integration
involved towards cloud topics?} This question is devoted to measure how
publication on data integration are applied towards the cloud computing
environment.

\item \textit{\textbf{RQ3:} How and in which context have data integration
