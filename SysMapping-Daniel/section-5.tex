...
As said aforementioned, some of these measures ({\sf cost/call, maxCall/day}) are static and explicitly specified by the service provider. 
...
According to our approach and in our case study, energy producers are modeled as data services with associated ``agreed'' SLAs.
