...
Thus, given a query, its associated QoS preferences and  services that can potentially be data providers, our approach for addressing SLA guided data  integration consists in three steps.  
\begin{itemize}
